...
void setup()
{
  ...
  int digit1 = 10; //Pin 10
  int digit2 = 11; //Pin 11
  int digit3 = 12; //Pin 12
  int digit4 = 13; //Pin 13
...
void loop()
{
  ...
  //Other examples
  myDisplay.DisplayString(tempString, 4); //Display string, no decimal point
  ...
  //Serial.println("Segundos: " + deciSecond);
  //Serial.println("minutos: " + deciMinut);
  delay(5);
}
